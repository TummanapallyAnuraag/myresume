...
\definecolor{llb}{rgb}{0.25,0.25,0.25}
...
\newcommand{\guide}[1]{\textit{\textcolor{llb}{#1}}}
%-------------------------------------------------------------------------
...
\guide{Guide: Prof. D. Manjunath, Electrical Engineering, IIT Bombay}\\[-0.6cm]
\begin{itemize}
...
\guide{Guide: Prof. V. R. Satpute, Electronics $\&$ Communication Engineering, VNIT Nagpur}\\[-0.6cm]
\begin{itemize}
...
\guide{Instructor: Prof. Abhay Karandikar, IIT Bombay}\\[-0.6cm]
	\begin{itemize}
...
\guide{Instructor: Prof. Amit Sethi, IIT Bombay}\\[-0.6cm]
\begin{itemize}
...
\guide{Instructor: Prof. D. Manjunath, IIT Bombay}\\[-0.6cm]
	\begin{itemize}
	\item Understood SDN
...
\begin{itemize}[leftmargin=0.4cm]
\item \textbf {Web Secretary \textpipe \hspace{0.05cm} \mystyle{Hostel 1, IIT Bombay}} 
\hfill{(\textit{Jul'17 - Jun'18})}\\[-0.6cm]
    \begin{itemize}
	\item Development and Maintenance of Hostel 1 Web site, and Computers.
	\end{itemize}
\item \textbf{Student Companion \textpipe \hspace{0.05cm} \mystyle{Institute Student Companion Program, IIT Bombay}}
\hfill{(\textit{Jul'18 - Jun'19})}\\[-0.6cm]
    \begin{itemize}
			\item \textbf{Mentored} 7 M.Tech students by providing continuous help and support throughout the year\vspace{-0.1cm}
            \item Played a key role in Department orientation, which included course registrations, informal sessions and lab visits for
PG and PhD freshmen in \textit{Communication Engineering} specialisation.
		\end{itemize}
\item \textbf{PG Bridge Course Overall Coordinator \textpipe \hspace{0.05cm} \mystyle{Electrical Department, IIT Bombay}}
\hfill{(\textit{Jul'18})}\\[-0.6cm]
    \begin{itemize}
		...
		\end{itemize}
\item \textbf{Web Nominee \textpipe \hspace{0.05cm} \mystyle{PGAC IIT Bombay}}
\hfill{(\textit{Jul'18 - Jun'19})}\\[-0.6cm]
\item \textbf{Web Coordinator \textpipe \hspace{0.05cm} \mystyle{Students' Reading Group, Electrical Department, IIT Bombay}} \hfill{(\textit{Jul'18 - Jun'19})}
\end{itemize}
...
\begin{itemize}[leftmargin=0.4cm]
    \item \textbf{Volunteered} for \textbf{Python} workshop by PGAC, IIT Bombay \hfill{(\textit{Oct'18})}\\[-0.6cm]
        \item \textbf{Volunteered} for \textbf{Linux} workshop for Electrical Department PG Bridgecourse, IIT Bombay \hfill{(\textit{Jul'19})}\\[-0.6cm]
